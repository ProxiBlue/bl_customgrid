...
class BL_CustomGrid_Model_System_Config_Source_Default_Param_Behaviour_Array
{
    public function toOptionArray()
    {
        ...
        return array(
            ...
            array(
                'value' => BL_CustomGrid_Model_Grid::GRID_DEFAULT_PARAM_MERGE_DEFAULT,
                'label' => $helper->__('Merge Values (Natural Order)'),
            ),
            array(
                'value' => BL_CustomGrid_Model_Grid::GRID_DEFAULT_PARAM_MERGE_BASE_ORIGINAL,
                'label' => $helper->__('Merge Values (Custom on Original)'),
            ),
            array(
                'value' => BL_CustomGrid_Model_Grid::GRID_DEFAULT_PARAM_MERGE_BASE_CUSTOM,
